...
for (const file of ["tree-sitter-perl.wasm", "node-types.json", "provenance.json", "scanner-literal-class.patch", "prototype-attributes.patch", "legacy-foreach-qw.patch", "interpolated-subscript-arrow.patch", "LICENSE"]) {
